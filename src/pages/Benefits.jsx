...
const Benefits = () => {
  ...
  return (
    <div className='min-h-screen bg-amber-500'>
      {/* Section 1 */}
      <div className="flex flex-col md:flex-row bg-[#FAF2E8] justify-center items-center p-6 md:p-12 gap-y-10 md:gap-[15%]">
        <div className="w-full max-w-[400px] h-[300px] md:w-[500px] md:h-[500px]">
          ...
          >
            ...
            <image
              xlinkHref="/images/genzhome2.jpg"
              width="100%"
              height="100%"
        ...
        <div className='w-full max-w-[500px] space-y-4 text-center md:text-left'>
          ...
          className="bg-[#334238] text-[#FAF2E8] px-4 py-2 rounded-full">
            Get Involved
          </button>
        </div>
      </div>
      ...
      {/* Section 2 */}
      <div className="flex flex-col-reverse md:flex-row bg-[#FAF2E8] justify-center items-center p-6 md:p-14 gap-y-10 md:gap-[20%]">
        <div className='w-full max-w-[500px] space-y-4 text-center md:text-left'>
          <h2 className='font-extrabold text-3xl sm:text-4xl md:text-5xl text-[#334238]'>
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/images/genshome3.jpg')",
